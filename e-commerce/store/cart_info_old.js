    ...
    ADD_CART_ITEMS (state, data) {
        ...
        if(state.cart_items[data.id] && state.cart_items[data.id][sel_price_type_id] && state.cart_items[data.id][sel_product_type_infos]){
            ...
            let obj = {
                ...
                price: sel_price_list_infos.discount_price?parseFloat(data.sel_unit_price - ((data.sel_unit_price * sel_price_list_infos.discount_price) / 100)):parseFloat(data.sel_unit_price - ((data.sel_unit_price * sel_price_list_infos.price) / 100)),
