            ...
            <div class="col-md-8">
                ...
                <div v-else class="form_block">
                    <div class="mb-4">
                        ...
                        <div><input type="text" placeholder="Enter company name" class="form-control" v-model="formData.company_name" @keyup="slug_config" ref="company_name" /></div>
                    </div>
                    <div class="mb-4">
                        <label>Slug</label>
...
export default {
    ...
    methods: {
        ...
        slug_config(){            
            this.formData.slug = this.$strSlug(this.formData.company_name)
        },
        async load_req_data(id){
            this.form_loader = true;
            
            this.$axios.get('/api/companies/edit/' + id, this.$parent.header_config).then( (response) => {
        ...
        async formSubmit(){
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.companySubmit(submit_data);
                ...
                if(this.form_action == 'save'){
                    ...
                    this.formData.exist_logo = this.$store.state.company_info.get_data['logo']
                }
            }            
        },
        form_reset(){
