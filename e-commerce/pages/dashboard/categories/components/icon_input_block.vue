...
<style lang="scss" scoped>    
    ...
    .category_icon_block > div{
        width: 100%; height: 100%; text-align: center;
    }    
    .category_icon_block span.browse_btn{
        position: absolute;
        bottom: 40%;
        left: 0;
        right: 0;
    ...
    .category_icon_block:hover span.browse_btn{
        background-color: purple;
        opacity: 1.0;
    }
    .category_icon_block :deep(img){
        width: 170px;
        height: 170px;
        object-fit: contain;
        /* padding: 5px; */
    ...
    .category_icon_block :deep(.action_btn){
        position: absolute;
        right: 0;
        bottom: 0px;
        width: 24px;
    ...
    .category_icon_block :deep(.cancel_btn){
        right: -10px;
        top: -10px;        
    }
    input[type="file"]{
