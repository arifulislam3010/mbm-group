...
export default {
    ...
    methods: {
        ...
        async load_req_data(id){
            ...
            this.$axios.get('/api/delivery-persons/edit/' + id, this.$parent.header_config).then( (response) => {
        ...
        async formSubmit(){
            ...
            if(this.formData.user_info.full_name.trim()==''){
                ...
                return false;
            } else if((this.pwd_change_allow || this.edit_content_id=='' || this.edit_content_id==null) && this.formData.password.trim()==''){
                this.$toast.error('Please enter password', {icon: "Warning"});
                return false;
            } else if((this.pwd_change_allow || this.edit_content_id=='' || this.edit_content_id==null) && this.formData.password.trim()!==this.confirm_password.trim()){
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.deliveryPersonSubmit(submit_data);
