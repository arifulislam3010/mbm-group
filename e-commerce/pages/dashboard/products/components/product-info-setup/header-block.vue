<template>
    <div :class="['header',{active:$parent.$parent.selected_info_index==cur_index}]" @click="$parent.$parent.select_entry(cur_index)">
        <div class="drag_cross">
            <i class="fa fa-up-down-left-right"></i>
        </div>
        <div class="up_down_btn">
            <i v-if="$parent.$parent.selected_info_index==cur_index" class="fa fa-chevron-up"></i>
