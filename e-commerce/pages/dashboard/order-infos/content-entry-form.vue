            ...
            <div class="col-md-8">
                ...
                <div v-else class="form_block">
                    <div class="mb-4">
                        ...
                        <div><input type="text" placeholder="Enter generic name" class="form-control" v-model="formData.generic_name" @keyup="slug_config" ref="generic_name" /></div>
                    </div>
                    <div class="mb-4">
                        <label>Slug</label>
...
export default {
    ...
    methods: {
        ...
        async formSubmit(){
            ...
            if(this.formData.generic_name.trim()==''){
                this.$toast.error('Please enter generic name', {icon: "Warning"});
                this.$refs.generic_name.focus();
                return false;
            ...
            if(confirm('Are you sure to submit it?')){
                ...
                await this.$parent.orderSubmit(submit_data);
