        ...
        <template v-else>
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <DataInfoForm :column="'full_name'" :isize="'full'" :placeholder="'Enter full name'" :type="'text'" />
                </div>
                <div class="col-md-6 mb-3">
                    <label>Contact Number</label>
                    <DataInfoForm :column="'contact_no'" :isize="'full'" :placeholder="'Enter contact number'" :type="'text'" />
                </div>
            </div>
            <div class="row">                
                <div class="col-md-7 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <DataInfoForm :column="'label_id'" :type="'radio'" :data="$store.state.shipping_addr_labels" :tf="'title'" />
                        </div>
                        <div class="col-md-4 mb-3">
                            <label>Status</label>
