            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-input mt-2">
                        ...
                        <input v-model="form_data.login_id" class="form-control" placeholder="Enter mobile number" @keyup.enter="form_submit" ref="login_id" />
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-input mt-2">
...
export default {
    ...
    methods: {
        ...
        async form_submit(){
            ...
            //     return false;
            // }else 
            if(!this.$validateContactNumber(getLoginId.trim())){
