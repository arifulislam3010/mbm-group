                        ...
                        $s =  $date->format('s');
                            ...
                            foreach ($request->occurs_on as $key => $value) {
                                if($value){
                                    ...
                                    switch ($key) {
                                        case 1:
                                           $syllabus->start_date = $date->modify('next saturday');
                                            break;
                                        case 2:
                                           $syllabus->start_date = $date->modify('next sunday');
                                            break;
                                        case 3:
                                           $syllabus->start_date = $date->modify('next monday');
                                            break;
                                        case 4:
                                            $syllabus->start_date = $date->modify('next tuesday');
                                            break;
                                        case 5:
                                           $syllabus->start_date = $date->modify('next wednesday');
                                            break;
                                        case 6:
                                           $syllabus->start_date = $date->modify('next thursday');
                                            break;
                                        case 7:
                                           $syllabus->start_date = $date->modify('next friday');
                                            break;
                                    ...
                                    $syllabus->start_date =  date_time_set($syllabus->start_date, $h, $i, $s);
