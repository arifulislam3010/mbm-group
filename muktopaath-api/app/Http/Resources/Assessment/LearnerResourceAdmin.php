...
class LearnerResourceAdmin extends JsonResource
{
    /**
    ...
    {   
        ...
        return [
            ...
            'quiz_data' => $this->quiz_data!=null?json_decode($this->quiz_data):[],
            'quiz_marks' => $this->quiz_marks!=null?json_decode($this->quiz_marks):[],
