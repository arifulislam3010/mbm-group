...
use Muktopaath\Course\Interfaces\TimelineRepositoryInterface;
use Muktopaath\Course\Models\Course\Timeline;
...
class TimelineRepository implements TimelineRepositoryInterface
{
    ...
    public function comment(){
        ...
        $data = TimelineComment::select('timeline_comments.*','u.photo','u.id as user_id','u.name as creator')
