...
use Muktopaath\Course\Http\Resources\SyllabusResource;
...
class SyllabusResourceUnit extends JsonResource
{
    /** 
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'lessons'            => $this->lessons?SyllabusResource::collection($this->lessons):$this->lessons,
        ];
    }
}
