...
use Muktopaath\Course\Http\Resources\CoursePublic as CourseResourcesPublic;
...
use Muktopaath\Course\Http\Resources\SyllabusResourcePublicUnits;
use Auth;
...
class Batch extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'syllabus'                  => SyllabusResourcePublicUnits::collection($this->units),
            ...
            'course'                    => new CourseResourcesPublic($this->course),
